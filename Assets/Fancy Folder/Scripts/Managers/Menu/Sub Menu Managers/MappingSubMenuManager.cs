...
namespace Menu.Managers.SubMenus {
	public class MappingSubMenuManager : SubMenuManager {
		//int _subIndex;
		...
		//				Leave();
		//				((MappingMenuManager)Parent).NavigateLeft();
		//			}

		//			if (Base.InputManager.RightDown) {
		//				Leave();
		//				((MappingMenuManager)Parent).NavigateRight();
		//			}
		...
		//				Leave();
		//				((MappingMenuManager)Parent).Exit();
		//			}
		//		}
		//	}
